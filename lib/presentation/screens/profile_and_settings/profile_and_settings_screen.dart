                ...
                children: [
                      ...
                      : Container(
                          ...
                          child: Padding(
                            ...
                            child: AccountUserCard(
                              ...
                              imgWidget: controller.driver.image == null ||
                                      controller.driver.image == 'null' ||
                                      controller.driver.image!.isEmpty
                                  ? Image.asset(MyImages.defaultAvatar,
                                      height: 85)
                                  : Container(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Align(
                              ...
                              child: HeaderText(
                                  text:
                                      '${Get.find<ApiClient>().getCurrencyOrUsername(isSymbol: true)}${controller.isLoading ? '0.00' : StringConverter.formatNumber(controller.driver.balance ?? '0')}',
                                  textStyle: boldLarge.copyWith(
                                      color: MyColor.colorBlack, fontSize: 16)),
                            ),
                          ),
                        ],
                      ),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const CustomDivider(space: Dimensions.space15),
                        MenuRowWidget(
                            image: MyImages.wallet,
                            label: MyStrings.myWallet,
                            onPressed: () =>
                                Get.toNamed(RouteHelper.myWalletScreen)),
                        const CustomDivider(space: Dimensions.space15),
                        MenuRowWidget(
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        HeaderText(
                            text: MyStrings.rides.tr.toUpperCase(),
                            textStyle:
                                regularLarge.copyWith(color: MyColor.bodyText)),
                        const SizedBox(height: Dimensions.space20),
                        MenuRowWidget(
                            ...
                            onPressed: () {
                              Get.toNamed(RouteHelper.cityRideScreen,
                                  arguments: [true]);
                            }),
                        // const CustomDivider(space: Dimensions.space15),
                        // MenuRowWidget(
                        //     image: MyImages.intercity,
                        //     label: MyStrings.interCityRide,
                        //     onPressed: () => Get.toNamed(
                        //         RouteHelper.interCityRideScreen,
                        //         arguments: [true])),
                        spaceDown(Dimensions.space10),
                      ],
                    ),
                      ...
                      children: [
                        ...
                        MenuRowWidget(
                            ...
                            onPressed: () => Get.toNamed(
                                ...
                                arguments: [MyStrings.interCity, true])),
                        const CustomDivider(space: Dimensions.space15),
                        MenuRowWidget(
                            image: MyImages.transaction,
